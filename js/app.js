...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <footer>Rating: ${product.rating.rate}, ${product.rating.count}</footer>
      <h2>Price: $ ${product.price}</h2>
      <button onclick="addToCart(${product.id}, ${parseFloat(product.price)})" id="addToCart-btn" class="buy-now btn btn-white">add to cart</button>
